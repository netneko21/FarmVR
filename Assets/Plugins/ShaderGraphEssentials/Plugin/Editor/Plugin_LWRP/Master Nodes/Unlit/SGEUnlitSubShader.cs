...
{
    [Serializable]
    class LightWeightUnlitSubShader : ISGEUnlitSubShader
    {
        ...
        private const string PassPath = "SGE_LightweightUnlitPass.template";
        private const string ExtraPassPath = "SGE_LightweightUnlitExtraPasses.template";
        ...
        public string GetSubshader(IMasterNode masterNode, GenerationMode mode, List<string> sourceAssetDependencyPaths = null)
        {
            ...
            {
                var materialTags = unlitMasterNode.GetMaterialTags();
                ...
                var materialOptions = unlitMasterNode.GetMaterialOptions();
            ...
            if (unlitMasterNode.CustomEditor != null && !unlitMasterNode.CustomEditor.Equals(String.Empty))
                subShader.AppendLine(@"CustomEditor ""{0}""", unlitMasterNode.CustomEditor);
        ...
        static string GetShaderPassFromTemplate(string template, SGEUnlitMasterNode masterNode, Pass pass, GenerationMode mode, SurfaceMaterialOptions materialOptions)
        {
            // ----------------------------------------------------- //
            //                         SETUP                         //
            // ----------------------------------------------------- //
            ...
            bool recomputePositionAfterVertexTransform =
                masterNode.IsSlotConnected(SGEUnlitMasterNode.PositionSlotId) && masterNode.UpdateVertexPosition.isOn;
