...
{
    class CreateSGEUnlitShaderGraph : EndNameEditAction
    {
        [MenuItem("Assets/Create/Shader/SGE Unlit Graph", false, 208)]
        public static void CreateMaterialGraph()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateSGEUnlitShaderGraph>(),
        ...
        public override void Action(int instanceId, string pathName, string resourceFile)
        {
            ...
            graph.AddNode(new SGEUnlitMasterNode());
