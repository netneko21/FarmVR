...
namespace VRKeys {
	...
	public class Placement : MonoBehaviour {
		...
		void Resize () 
		{
			...
			{
				initialHandDistance = Vector3.Distance (XRTracking.leftController.transform.position, XRTracking.rightController.transform.position);
				initialApplyScale = applyScale;
				return;
			}

			var curDistance = Vector3.Distance (XRTracking.leftController.transform.position, XRTracking.rightController.transform.position);
